...
//        verrecyclerView.setLayoutManager(new LinearLayoutManager(this));
    ...
    private List<SearchProduct> getProducts(String searchQuery) {
        ...
        product1List.add(new SearchProduct("heritage",R.drawable.img_1,"9 min","1 Ltr",47));
        ...
        product1List.add(new SearchProduct("heritage special milk",R.drawable.akshayala_milk,"9 min","1 Ltr",37));
